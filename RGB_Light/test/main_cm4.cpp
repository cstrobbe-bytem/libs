...
/* P10_0 */
#define TCPWM_R1_PORT                   GPIO_PRT10
#define TCPWM_R1_PIN                    0u
#define TCPWM_R1_MUX                    P10_0_TCPWM0_LINE28
#define TCPWM_R1_CNT_PWM                TCPWM0_GRP0_CNT0
#define PCLK_TCPWM_R1_CLOCKS_PWM        PCLK_TCPWM0_CLOCKS0

/* P10_1 */
#define TCPWM_G1_PORT                   GPIO_PRT10
#define TCPWM_G1_PIN                    1u
#define TCPWM_G1_MUX                    P10_1_TCPWM0_LINE29
#define PCLK_TCPWM_G1_CLOCKS_PWM        PCLK_TCPWM0_CLOCKS1

/* P10_2 */
#define TCPWM_B1_PORT                   GPIO_PRT10
#define TCPWM_B1_PIN                    2u
#define TCPWM_B1_MUX                    P10_2_TCPWM0_LINE30
#define PCLK_TCPWM_B1_CLOCKS_PWM        PCLK_TCPWM0_CLOCKS2
...
int main(void)
{
    ...
    Cy_SysClk_PeriphAssignDivider(PCLK_TCPWM_R1_CLOCKS_PWM, (cy_en_divider_types_t)CY_SYSCLK_DIV_16_BIT, TCPWM_PERI_CLK_DIVIDER_NO_PWM);
    ...
    /*------------------------------*/    
    Cy_GPIO_Pin_Init(TCPWM_R1_PORT, TCPWM_R1_PIN, &pin_cfg1);
    
    /* Initialize TCPWM0_GRPx_CNTx_PWM_PR as PWM-PR Mode & Enable */
    Cy_Tcpwm_Pwm_Init(TCPWM_R1_CNT_PWM, &MyPWM_config);
    Cy_Tcpwm_Pwm_Enable(TCPWM_R1_CNT_PWM);
    Cy_Tcpwm_TriggerStart(TCPWM_R1_CNT_PWM);
